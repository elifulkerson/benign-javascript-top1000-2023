var deviceType = "DESKTOP";
    ...
    carouselAttributes.carouselId               = "AYCL";
    ...
    carouselAttributes.carouselHeading          = "Included with membership";
    ...
    carouselAttributes.colorPalette             = "inverse";
        ...
        carouselAttributes.contextId                = "AudibleMostPopularListensAYCLStrategy";
        carouselAttributes.isAudibleMarketplace     = "false";

        
        var contextMetadata = {};
        
            contextMetadata["location"] = "HP";
