var rtlLangs = ['ar','arc','arz','bcc','bgn','bqi','ckb','dv','fa','glk','he','kk-cn','kk-arab','khw','ks','ku-arab','lki','lrc','luz','mzn','nqo','pnb','ps','sd','sdh','ug','ur','yi'],
    translationsHash = '499c0d07',
    /**
     * This variable is used to convert the generic "portal" keyword in the data-jsl10n attributes
     * e.g. 'data-jsl10n="portal.footer-description"' into a portal-specific key, e.g. "wiktionary"
     * for the wiktionary portal.
     */
    translationsPortalKey = 'wiktionary',
    /**
    ...
    **/
    portalSearchDomain = 'wiktionary.org';
    /*
