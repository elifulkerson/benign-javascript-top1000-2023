...
window.$Nav && $Nav.when("util.templates").run("FlyoutErrorTemplate", function(templates) {
  ...
  , filterAliases: []
  , pageType: "Gateway"
  , requestId: "AFJETZ5XFM8SQEP6PHSW"
  , sessionId: "460-3737067-6138109"
  , language: "zh_CN"
  , customerId: ""
  , asin: ""
  , b2b: 0
...
window.$Nav && $Nav.declare('config.sessionId','460\x2D3737067\x2D6138109');
window.$Nav && $Nav.declare('config.requestId','AFJETZ5XFM8SQEP6PHSW');

window.$Nav && $Nav.declare('config.alexaListEnabled',false);

window.$Nav && $Nav.declare('config.readyOnATF',true);

window.$Nav && $Nav.declare('config.dynamicMenuArgs',{"rid":"AFJETZ5XFM8SQEP6PHSW","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});
...
window.$Nav && $Nav.declare('config.hashCustomerAndSessionId','9dc517759c08e9abdc20527b4112ed623e4a3a5c');
