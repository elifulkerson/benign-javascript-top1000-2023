...
img.src=this.src;});return $.when.apply($,dfds);},ws:function(url,callback)
{if(window.WebSocket)
{if(helper.isdevel())
{url+='_dev';}
...
{var is_image=$(res.html);if(is_image.find('img').length>0){is_image.find('img').each(function(){var tmpImg=new Image();tmpImg.src=$(this).attr('src');tmpImg.onload=function(){dWidget._append(el,res);};tmpImg.onerror=function(){dWidget._append(el,res);}});}else{this._append(el,res);$(document.body).trigger("sticky_kit:recalc");}},_aftergenerate:function(el)
...
var[dsrec,key]=await helper.deferrer_rec(el);console.log(`[portal][src-rec-ab_${key}] : done.`,dsrec);var trcname=(typeof dsrec.tracking_rec!=='undefined')?dsrec.tracking_rec:'internal';switch(dsrec.src){case'bytedance':var loc={};var MD5=function(d){var r=M(V(Y(X(d),8*d.length)));return r.toLowerCase()};function M(d){for(var _,m="0123456789ABCDEF",f="",r=0;r<d.length;r++)_=d.charCodeAt(r),f+=m.charAt(_>>>4&15)+m.charAt(15&_);return f}function X(d){for(var _=Array(d.length>>2),m=0;m<_.length;m++)_[m]=0;for(m=0;m<8*d.length;m+=8)_[m>>5]|=(255&d.charCodeAt(m/8))<<m%32;return _}function V(d){for(var _="",m=0;m<32*d.length;m+=8)_+=String.fromCharCode(d[m>>5]>>>m%32&255);return _}function Y(d,_){d[_>>5]|=128<<_%32,d[14+(_+64>>>9<<4)]=_;for(var m=1732584193,f=-271733879,r=-1732584194,i=271733878,n=0;n<d.length;n+=16){var h=m,t=f,g=r,e=i;f=md5_ii(f=md5_ii(f=md5_ii(f=md5_ii(f=md5_hh(f=md5_hh(f=md5_hh(f=md5_hh(f=md5_gg(f=md5_gg(f=md5_gg(f=md5_gg(f=md5_ff(f=md5_ff(f=md5_ff(f=md5_ff(f,r=md5_ff(r,i=md5_ff(i,m=md5_ff(m,f,r,i,d[n+0],7,-680876936),f,r,d[n+1],12,-389564586),m,f,d[n+2],17,606105819),i,m,d[n+3],22,-1044525330),r=md5_ff(r,i=md5_ff(i,m=md5_ff(m,f,r,i,d[n+4],7,-176418897),f,r,d[n+5],12,1200080426),m,f,d[n+6],17,-1473231341),i,m,d[n+7],22,-45705983),r=md5_ff(r,i=md5_ff(i,m=md5_ff(m,f,r,i,d[n+8],7,1770035416),f,r,d[n+9],12,-1958414417),m,f,d[n+10],17,-42063),i,m,d[n+11],22,-1990404162),r=md5_ff(r,i=md5_ff(i,m=md5_ff(m,f,r,i,d[n+12],7,1804603682),f,r,d[n+13],12,-40341101),m,f,d[n+14],17,-1502002290),i,m,d[n+15],22,1236535329),r=md5_gg(r,i=md5_gg(i,m=md5_gg(m,f,r,i,d[n+1],5,-165796510),f,r,d[n+6],9,-1069501632),m,f,d[n+11],14,643717713),i,m,d[n+0],20,-373897302),r=md5_gg(r,i=md5_gg(i,m=md5_gg(m,f,r,i,d[n+5],5,-701558691),f,r,d[n+10],9,38016083),m,f,d[n+15],14,-660478335),i,m,d[n+4],20,-405537848),r=md5_gg(r,i=md5_gg(i,m=md5_gg(m,f,r,i,d[n+9],5,568446438),f,r,d[n+14],9,-1019803690),m,f,d[n+3],14,-187363961),i,m,d[n+8],20,1163531501),r=md5_gg(r,i=md5_gg(i,m=md5_gg(m,f,r,i,d[n+13],5,-1444681467),f,r,d[n+2],9,-51403784),m,f,d[n+7],14,1735328473),i,m,d[n+12],20,-1926607734),r=md5_hh(r,i=md5_hh(i,m=md5_hh(m,f,r,i,d[n+5],4,-378558),f,r,d[n+8],11,-2022574463),m,f,d[n+11],16,1839030562),i,m,d[n+14],23,-35309556),r=md5_hh(r,i=md5_hh(i,m=md5_hh(m,f,r,i,d[n+1],4,-1530992060),f,r,d[n+4],11,1272893353),m,f,d[n+7],16,-155497632),i,m,d[n+10],23,-1094730640),r=md5_hh(r,i=md5_hh(i,m=md5_hh(m,f,r,i,d[n+13],4,681279174),f,r,d[n+0],11,-358537222),m,f,d[n+3],16,-722521979),i,m,d[n+6],23,76029189),r=md5_hh(r,i=md5_hh(i,m=md5_hh(m,f,r,i,d[n+9],4,-640364487),f,r,d[n+12],11,-421815835),m,f,d[n+15],16,530742520),i,m,d[n+2],23,-995338651),r=md5_ii(r,i=md5_ii(i,m=md5_ii(m,f,r,i,d[n+0],6,-198630844),f,r,d[n+7],10,1126891415),m,f,d[n+14],15,-1416354905),i,m,d[n+5],21,-57434055),r=md5_ii(r,i=md5_ii(i,m=md5_ii(m,f,r,i,d[n+12],6,1700485571),f,r,d[n+3],10,-1894986606),m,f,d[n+10],15,-1051523),i,m,d[n+1],21,-2054922799),r=md5_ii(r,i=md5_ii(i,m=md5_ii(m,f,r,i,d[n+8],6,1873313359),f,r,d[n+15],10,-30611744),m,f,d[n+6],15,-1560198380),i,m,d[n+13],21,1309151649),r=md5_ii(r,i=md5_ii(i,m=md5_ii(m,f,r,i,d[n+4],6,-145523070),f,r,d[n+11],10,-1120210379),m,f,d[n+2],15,718787259),i,m,d[n+9],21,-343485551),m=safe_add(m,h),f=safe_add(f,t),r=safe_add(r,g),i=safe_add(i,e)}return Array(m,f,r,i)}function md5_cmn(d,_,m,f,r,i){return safe_add(bit_rol(safe_add(safe_add(_,d),safe_add(f,i)),r),m)}function md5_ff(d,_,m,f,r,i,n){return md5_cmn(_&m|~_&f,d,_,r,i,n)}function md5_gg(d,_,m,f,r,i,n){return md5_cmn(_&f|m&~f,d,_,r,i,n)}function md5_hh(d,_,m,f,r,i,n){return md5_cmn(_^m^f,d,_,r,i,n)}function md5_ii(d,_,m,f,r,i,n){return md5_cmn(m^(_|~f),d,_,r,i,n)}function safe_add(d,_){var m=(65535&d)+(65535&_);return(d>>16)+(_>>16)+(m>>16)<<16|65535&m}function bit_rol(d,_){return d<<_|d>>>32-_}
var meta={'reqId':MD5('bytedance'+Date.now()),'appkey':'58399ee40738706045e0b81e902f3f94',};meta.nonce=Date.now();meta.sign=MD5('Nzc0Njc4NGZkYWQ2ZDgxNWUwMzE5ZGY3NjQ4YzEyYWI'+meta.appkey+meta.nonce).toUpperCase();if(typeof localStorage!=='undefined'){var tokenKey='226201';var tokenCache=JSON.parse(localStorage.getItem('__tea_cache_tokens_'+tokenKey));loc.uid=[tokenCache.web_id,tokenCache.user_unique_id].join('$##$');}
var payload_rec={reqId:meta.reqId,user:loc,rec:{extra:{platform:(helper.ismobile())?"wap":"web",subsitename:document.querySelector('meta[property="og:site_name"]').content,}},size:parseInt(size),};if(typeof itp_include_filter_categories!=='undefined'){payload_rec.rec.extra.include_filter_categories=itp_include_filter_categories;}
if(typerec=='detail'){payload_rec.rec.extra.parent_good_id=`alldetik_${document.querySelector('meta[name~="dtk:articleid"]').content}`,payload_rec.rec.extra.parent_good_title=document.title;payload_rec.rec.extra.parent_good_tags=document.querySelector('meta[name~="keywords"]').content.replace(/\,/g,"$##$");payload_rec.rec.extra.parent_good_cate=document.querySelector('meta[name~="kanalid"]').content.split('-').slice(-2).join("$##$");}
var client=$.ajax({type:"POST",url:dsrec.url,headers:{"metadata":JSON.stringify(meta),"Content-Type":"application/json",},data:JSON.stringify(payload_rec),}).then(function(response){var items=[]
var responseArticles=response.value.data
items=responseArticles.map(function(row){var imgUrl=row.extra.image_url
var arrImages=imgUrl.split('$##$')
if(arrImages.length>1){imgUrl=arrImages[0]}
var id_bd=row.idStr.split("_");if(typeof id_bd[1]!=='undefined'){id_bd=id_bd[1];}
return{articleurl:row.extra.article_url,desktopurl:row.extra.article_url+'?bytedance=true',id:id_bd,imageurl:imgUrl,title:row.extra.title,unixtime:parseInt(row.extra.pub_time+'000')}})
return{body:items}}).then(function(data){dWidget.rec_pull(data,el,trcname);}).catch(function(error){$('.ph-insertion-block').hide();});break;case'internal':var client={url:dsrec.url+dtma+'?size='+size+'&nocache=1&ids='+excids+"&acctype="+acctyp,type:'GET',xhrFields:{withCredentials:true},dataType:'json',success:function(data){dWidget.rec_pull(data,el,trcname);},error:function(textStatus,errorThrown){$('.ph-insertion-block').hide();}};if(typeof itp_internal_included_channels!=='undefined'){client.type='POST';client.data=JSON.stringify({excludeChannels:[],includeChannels:itp_internal_included_channels,});client.contentType="application/json; charset=utf-8";}
...
{if(typeof rec.body!=='undefined'){let pf='_itp';let _pfx='d-panel-';let _attr=['name','type','disable-source'];let _numb='[pt_number]';let _types='artikel';let _panel='berita rekomendasi';let _sec='';let _act='';var the_data={};var firrec='recommendation_firstrow';var secrec='recommendation_secondrow';var ordinals={1:'first',2:'second',3:'third',4:'fourth',5:'fifth',6:'sixth',7:'seventh',8:'eighth',9:'ninth'};el.attr('d-recsource',datasrc);el.html(resapp.html).hide();the_data=rec.body;$.each(the_data,function(index,item){if(typeof index!=='undefined'){if(site_id==2){if((helper.ismobile()&&index>=4)||(!helper.ismobile()&&index>=6)){var insertion='#rec_loop_'+index;var idx=parseInt($(insertion).attr("article-idx"));var insertion_pt_opt={'dtr-evt':"newsfeed rekomendasi",'dtr-sec':"newsfeed rekomendasi",'dtr-act':"artikel newsfeed rekomendasi",'dtr-idx':helper.ismobile()?idx:idx+2,'dtr-ttl':item.title,'dtr-id':item.id,'onclick':"_pt(this)",'d-recsource':datasrc,};$(insertion).removeClass("ph-item");var mediaHtml=`
...
var __img=new Image();__img.src=_img;__img.style='display:none';__img.onload=function(){setTimeout(function(){dNewsfeed.print_img(e,_img);e.find('.ai_img').replaceWith(__img);},500);};__img.onerror=function(){setTimeout(function(){dNewsfeed.print_img(e,defaultimg);e.find('.ai_img').replaceWith(__img);},500)}},print_img:function(e,img)
{e.find('.ai_lqd').css('background-image','url('+img+')');e.find('.ratiobox').removeClass('ph-item');}}
var dFramebar={init:function()
{if(!helper.ismobile()){helper.loadscript('https://cdn.detik.net.id/assets/js/framebar/jquery.autocomplete.js');}
this.dc_get()
$('#search_navbar input[type="text"]').focus(function(){dFramebar.auto_complete($(this));});},oncomplete:function(){$('.dtkframebar__user__login').removeAttr('style');helper.loadscript('https://cdn.detik.net.id/libs/assets/js/framebar/dtkframebar-controller.js');},redirectUrlReplacer:function(originUrl){const url=new URL(originUrl);const args=new URLSearchParams(url.search);args.set('redirectUrl',window.location.href);if(args.has('parentURI')){args.set('parentURI',window.location.href);}
...
helper.loadscript('https://cdn.detik.net.id/assets/js/iframeresizer.js');},dc_get:function()
...
{el.keypress(function(){el.autocomplete({serviceUrl:"//suggestqueries.google.com/complete/search?client=chrome&callback=?",dataType:"jsonp",paramName:"q",lookupLimit:5,transformResult:function(n){return{suggestions:$.map(n[1],function(n){try{n=n.replace(/[\<\>\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"");}catch(e){helper.log(e);}
...
{let class_box_modal_dtkid=(typeof itp_dtkid_redirect_url!=='undefined'&&itp_dtkid_redirect_url==true)?'':'box_modal_dtkid';box='<a alt="'+obj.framebar_url.register+'" href="'+obj.framebar_url.register+'" class="daftar to_reg '+class_box_modal_dtkid+' dtkframebar__btn gtm_framebardc_daftar active">'+'Daftar MPC</a>\n'+'<a alt="'+obj.framebar_url.login+'" href="'+obj.framebar_url.login+'" class="masuk to_login '+class_box_modal_dtkid+' dtkframebar__btn gtm_framebardc_masuk">Masuk</a>';}}
return box;},}
...
{dWidget.init();dNewsfeed.init();dRecShow.init();}
