...
window.$Nav && $Nav.when("util.templates").run("FlyoutErrorTemplate", function(templates) {
  ...
  , filterAliases: []
  , pageType: "Gateway"
  , requestId: "1CYFQSRK0RMA5PFFKCGG"
  , sessionId: "134-4468074-6328528"
  , language: "en_CA"
  , customerId: ""
  , asin: ""
  , b2b: 0
...
window.$Nav && $Nav.declare('config.sessionId','134\x2D4468074\x2D6328528');
window.$Nav && $Nav.declare('config.requestId','1CYFQSRK0RMA5PFFKCGG');

window.$Nav && $Nav.declare('config.alexaListEnabled',false);

window.$Nav && $Nav.declare('config.readyOnATF',true);

window.$Nav && $Nav.declare('config.dynamicMenuArgs',{"rid":"1CYFQSRK0RMA5PFFKCGG","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});
...
window.$Nav && $Nav.declare('config.hashCustomerAndSessionId','4aa43e751f9ac6c2a5d7dee7fd4d101922d722a6');
