...
$(function(){
	...
	extra_carousel("extra_carousel02");
	//底部4小块滑动js
	$(".extra_foot .box ul li").bind("mouseover",function () {
		$(this).addClass("cur").siblings().removeClass("cur");
	})
	// 号外文字动画
	// var bottom_wrod_bg=$(".wrapper_extra .banner_top");
	// var bottom_wrod01=$(".wrapper_extra .banner_top .slogan .bottom_wrod01");
	// var bottom_wrod02=$(".wrapper_extra .banner_top .slogan .bottom_wrod02");
	// bottom_wrod01.css({left:-windowW});
	// bottom_wrod02.css({right:-windowW});
	// bottom_wrod_bg.animate({"opacity": 1},1500);
	// bottom_wrod01.animate({left:"176px",},1000);
	// bottom_wrod02.animate({right:"171px"},1000);
})
...
window.onresize=function(){
   ...
   // setTimeout(function(){
	if (windowW <= 1417 && windowWidth == false){
		...
		$scrollbar1.data("plugin_tinyscrollbar").options.trackSize = 404;
		...
		$scrollbar1.data("plugin_tinyscrollbar").options.trackSize = 420;
		$scrollbar1.data("plugin_tinyscrollbar").update();
	}
   // },100); 
}
