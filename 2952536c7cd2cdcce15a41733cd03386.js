...
window.$Nav && $Nav.when("util.templates").run("FlyoutErrorTemplate", function(templates) {
  ...
  , filterAliases: []
  , pageType: "Gateway"
  , requestId: "4EWZYM2F3CWDJKM3BWTE"
  , sessionId: "258-8853489-9331411"
  , language: "en_IN"
  , customerId: ""
  , asin: ""
  , b2b: 0
...
window.$Nav && $Nav.declare('config.sessionId','258\x2D8853489\x2D9331411');
window.$Nav && $Nav.declare('config.requestId','4EWZYM2F3CWDJKM3BWTE');

window.$Nav && $Nav.declare('config.alexaListEnabled',true);

window.$Nav && $Nav.declare('config.readyOnATF',true);

window.$Nav && $Nav.declare('config.dynamicMenuArgs',{"rid":"4EWZYM2F3CWDJKM3BWTE","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});
...
window.$Nav && $Nav.declare('config.hashCustomerAndSessionId','a0f4d8eeee87d6228391b15c32f55490c5022e08');
