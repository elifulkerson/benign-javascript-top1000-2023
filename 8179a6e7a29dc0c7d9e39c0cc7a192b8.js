...
window.$Nav && $Nav.when("util.templates").run("FlyoutErrorTemplate", function(templates) {
  ...
  , filterAliases: []
  , pageType: "Gateway"
  , requestId: "D4E3ZTPRQSZYPHA9FE63"
  , sessionId: "260-6428248-8961062"
  , language: "en_GB"
  , customerId: ""
  , asin: ""
  , b2b: 0
...
window.$Nav && $Nav.declare('config.sessionId','260\x2D6428248\x2D8961062');
window.$Nav && $Nav.declare('config.requestId','D4E3ZTPRQSZYPHA9FE63');

window.$Nav && $Nav.declare('config.alexaListEnabled',true);

window.$Nav && $Nav.declare('config.readyOnATF',true);

window.$Nav && $Nav.declare('config.dynamicMenuArgs',{"rid":"D4E3ZTPRQSZYPHA9FE63","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});
...
window.$Nav && $Nav.declare('config.hashCustomerAndSessionId','edc49bb4f98fcfcda4c779989cec6abee4803a6f');
