...
a = function(x){
	...
	var y="<div class='item' "+(x.e?x.e:'')+"><a href='"+x.h+"' "
	if(x.c)
...
d = function(n){
var c=[],hex = Math.abs(DJBHash(n)).toString(16)+'000000'
for(var i=0;i<6;i+=2)
...
var menuItem = {
	left:{
		1:{h:'//nga.cn/',t:'\u9996\u9875'},// 棣栭〉
		2:{h:'//bbs.nga.cn/',t:'\u8BBA\u575B'},// 璁哄潧
		3:{h:'//game.nga.cn/',t:"\u8BC4\u5206"},// 璇勫垎
		4:{h:'//tv.nga.cn',t:'\u8D5B\u4E8B'},// 璧涗簨
		5:{h:'//www.nga.cn/special/',t:'\u4E13\u9898'},// 涓撻��
		6:{h:'//app.nga.cn/',t:'\u79FB\u52A8\u7AEF'}// 绉诲姩绔�
		},
	right:{
		1:{u:1, b:1, h:'//bbs.nga.cn/nuke.php?func=ucp&uid='+uid, t:'<div style="zoom:1;display:inline;display:inline-block;font-size:2.307em;font-weight:bold;background:#'+d(uname)+';color:#fff;line-height: 1em;vertical-align: -0.3em;border-radius: 0.5em;overflow: hidden;transform:rotate(10deg);width:1em;text-align:center">'+uname.substr(0,1).toUpperCase()+'</div> '+c(uname,7,6,'...')},
		2:{u:1, b:1, h:'https://bbs.nga.cn/nuke.php?__lib=login&__act=account&logout', t:'<nobr>'+OUT+' \u767B\u51FA</nobr>'},// 鐧诲嚭
		3:{u:0, b:1, h:'https://bbs.nga.cn/nuke.php?__lib=login&__act=account&login', t:'<nobr>'+IN+' \u767B\u5F55</nobr>'},// 鐧诲綍
		4:{u:0, b:1, h:'https://bbs.nga.cn/nuke.php?__lib=login&__act=account&register', t:'<nobr>'+REG+' \u6CE8\u518C</nobr>'}// 娉ㄥ唽
		}
	}

var m = "<div id='mainMenu20180622'><div class='menu'><div class='right'>"

for(var k in menuItem.right)
	m+=a(menuItem.right[k])

m+="</div><div class='left'><div class='logo'>"+LOGO+"</div>"
