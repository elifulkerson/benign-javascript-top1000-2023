...
firebase.initializeApp({messagingSenderId:"922385855593"});

// Retrieve Firebase Messaging object.
const messaging = firebase.messaging();

// Add the public key generated from the console here.
messaging.usePublicVapidKey("BJohbpKCITu0nw8G63_mw1n0aMkbVFccYEEd-hN46XBoRmjSVcx6MsREmkHtKXoP3ep9ejzI4acGQUoXbWZqkwk");
...
if(document.cookie.indexOf('kgnotif_akuisisi') == -1){
    ...
    navigator.serviceWorker.register('/kgnotif-bolasport-sw.js').then(function(registration){
        ...
        messaging.requestPermission().then(function() {
            messaging.getToken().then(function(currentToken){
                ...
                try{
                    ...
                    window._izq.push(["syncFCMToken", currentToken]);
                }catch (error){	 	
                    console.log(error);
                }
...
messaging.onMessage(function(payload) {
    ...
    navigator.serviceWorker.register('/kgnotif-bolasport-sw.js');
