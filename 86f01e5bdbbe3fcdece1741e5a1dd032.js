...
var processJsonData = {
                    ...
                    if (serviceItem.length > 0) {
                        ...
                        for (var j = 0; j < serviceItem.length - 1; j++) {
                            ...
                            if (serviceItem[j] !== "0") {
                                ...
                                textToDisplayTiles += "<h2 class=\"title h4\" aria-label=\"" + serviceItemParts[2] + " Service Tile. Hit Enter to toggle between displaying and hiding details about this service.\">" + serviceItemParts[2] + "</h2>";
                                ...
                                panelTextToPass += "<button type=\"button\" class=\"close btn\" data-dismiss=\"modal\" aria-label=\"X will close details.\" style=\"font-size: 1.5em;\">X</button>";
                                panelTextToPass += "<div class=\"group\">";
                                panelTextToPass += "<div class=\"two-thirds\">";
                                panelTextToPass += "<h1 class=\"m-y-0 \">" + serviceItemParts[2] + "</h1>";
                                panelTextToPass += "<p class=\"lead\"><a href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\"  aria-label=\"" + serviceItemParts[4] + " Agency Details.\">" + serviceItemParts[4] + "</a></p>";
                                panelTextToPass += "<p>" + holderDescription + "</p><br>";
                                panelTextToPass += "<div class=\"btn-row m-b\">";
                                panelTextToPass += "<a href=\"" + serviceItemParts[3] + "\" id=\"launch-" + serviceNameToPass + "\" class=\"btn btn-default btn-block-xs\" aria-label=\"Launch Service for " + serviceItemParts[2] + " service. \"><span class=\"ca-gov-icon-computer\"></span> Launch Service</a>";
                                panelTextToPass += "<a href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"btn btn-default btn-block-xs\" aria-label=\" See Details for the " + serviceItemParts[2] + " service.\"><span class=\"ca-gov-icon-info\"></span> See Details</a>";
                                panelTextToPass += "                            </div>";
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 1000) {
                    ...
                    textToDisplay += "<p class=\"lead\"><a aria-label=\"" + dataToProcess[0].FriendlyName + " (" + dataToProcess[0].Acronym + ") Agency Details\" href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\">";
                    ...
                    textToDisplay += "<a aria-label=\"Launch Service of " + dataToProcess[0].ServiceName + "\" href=\"" + dataToProcess[0].ServiceUrl + "\" id=\"launch-" + serviceNameToPass + "\" class=\"btn btn-primary btn-block-xs\"><span class=\"ca-gov-icon-computer\"></span>";
                    textToDisplay += " &nbsp; <span>Launch Service</span>";
                    textToDisplay += "</a>&nbsp;";

                    textToDisplay += "<a aria-label=\"Contact Us page for " + dataToProcess[0].ServiceName + " service\" href=\"" + dataToProcess[0].ContactUrl + "\" id=\"service-" + serviceNameToPass + "\"   class=\"btn btn-primary btn-block-xs\">";
                    ...
                    if (arrayLength > 1) {
                        for (var i = 0; i < arrayLength; i++) {
                            if (!(this.apiData[i].ServiceName === currentService)) {
                                ...
                                texttopass += "<a aria-label=\"" + this.apiData[i].ServiceName + " Service Details\" href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"btn btn-default btn-xs\">" + this.apiData[i].ServiceName + "</a>";
                            }
                        }
                    }
    ...
    buildServiceCard: function (serviceId, serviceImage, serviceAgencyFriendlyName, serviceAgencyAcronym, serviceName, serviceUrl, serviceDescription, serviceContactPhone, lang, serviceLandingPage, agencyLandingPage) {
        ...
        cardToBuild += "\" alt=\"" + serviceName + " Service Icon\" class=\"img-responsive hidden-xs\">";
        cardToBuild += "</div>";
        cardToBuild += "<div class=\"col-lg-9\">";
        cardToBuild += "<a aria-label=\"" + serviceName + " Service Details\" href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"lead\">" + serviceName + "</a>";

        cardToBuild += "<div class=\"row\">";
        cardToBuild += "<div class=\"col-lg-7\">";
        cardToBuild += "<p itemprop=\"name\"><a  aria-label=\"" + serviceAgencyFriendlyName + " Agency Details\" href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\">" + serviceAgencyFriendlyName + "</a></p>";
        ...
        cardToBuild += "<a  aria-label=\"Service Detail for " + serviceName + " Service\" href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"btn btn-secondary btn-block btn-sm m-t-md\">Service Detail</a>";
        cardToBuild += "<div class=\"collapse collapse" + serviceId + "\">";
        cardToBuild += "</div>";
        cardToBuild += "</div>";
        cardToBuild += "</div>";
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 1000) {
                    ...
                    textToDisplay += "<a aria-label=\"Website Link to " +
                        this.apiData[r].FriendlyName +
                        "\"  href=\"" +
                        this.apiData[r].WebsiteURL +
                        "\" id=\"website-" +
                        friendlyNameId +
                        "\"  class=\"btn btn-default\"><span class=\"ca-gov-icon-computer\"></span> &nbsp;<span> Website</span></a>";
                    textToDisplay += "<a aria-label=\" Contact page for " +
                        this.apiData[r].FriendlyName +
                        "\" href=\"" +
                        this.apiData[r].ContactURL +
                        "\" id=\"contactpage-" +
                        friendlyNameId +
                        "\" class=\"btn btn-default\"><span class=\"ca-gov-icon-contact-us\"></span> &nbsp;<span> Contact</span></a>";
                    textToDisplay += "</div>";
                    textToDisplay +=
                    ...
                    if ((this.apiData[r].TwitterAccount) || (this.apiData[r].Facebook) || (this.apiData[r].YouTube)) {
                        ...
                        if (this.apiData[r].TwitterAccount) {
                            ...
                            textToDisplay += "<a aria-label=\"Twitter Information for " +
                                this.apiData[r].FriendlyName +
                                "\" href=\"https://twitter.com/" +
                                twitterItem +
                                "\" id=\"twitter-" +
                                friendlyNameId +
                                "\"><span class=\"ca-gov-icon-twitter\" aria-hidden=\"true\"><span class=\"sr-only\">Twitter Information for " +
                                this.apiData[r].FriendlyName +
                                "</span></span></a>";
                            textToDisplay += "</li>";
                        }
                        if (this.apiData[r].Facebook) {
                            ...
                            textToDisplay += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
                            textToDisplay += "<a aria-label=\"Facebook Information for " +
                                this.apiData[r].FriendlyName +
                                "\" href=\"https://www.facebook.com/" +
                                facebookItem +
                                "\" id=\"facebook-" +
                                friendlyNameId +
                                "\"><span class=\"ca-gov-icon-facebook\" aria-hidden=\"true\"><span class=\"sr-only\">Facebook Information for " +
                                this.apiData[r].FriendlyName +
                                "</span></span></a>";
                            textToDisplay += "</li>";
                        }
                        if (this.apiData[r].YouTube) {
                            ...
                            textToDisplay += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
                            textToDisplay += "<a  aria-label=\"YouTube Information for " +
                                this.apiData[r].FriendlyName +
                                "\" href=\"https://www.youtube.com/" +
                                youTubeItem +
                                "\" id=\"youtube-" +
                                friendlyNameId +
                                "\"><span class=\"ca-gov-icon-youtube\" aria-hidden=\"true\"><span class=\"sr-only\">YouTube Information for " +
                                this.apiData[r].FriendlyName +
                                "</span></span></a>";
                            textToDisplay += "</li>";
                        }
                ...
                if (loadCount < 50) {
                    ...
                    if (arrayLength > 0) {
                        ...
                        for (var i = 0; i < arrayLength; i++) {
                            ...
                            textToDisplayTiles += "<div class=\"teaser\">";
                            textToDisplayTiles += "<h2 class=\"title h4\" aria-label=\"" + this.apiData[i].ServiceName + " Service Tile. Hit Enter to toggle between displaying and hiding details about this service.\">" + this.apiData[i].ServiceName + "</h2>";
                            textToDisplayTiles += "</div>";
                            ...
                            panelTextToPass += "<div class=\"container\" style=\"padding-top: 5px;\">";
                            panelTextToPass += "<div class=\"card card-block\">";
                            panelTextToPass += "<button type=\"button\" class=\"close btn\" data-dismiss=\"modal\" aria-label=\"X button will close details.\" style=\"font-size: 1.5em;\">X</button>";
                            panelTextToPass += "<div class=\"group\">";
                            panelTextToPass += "<div class=\"two-thirds\">";
                            panelTextToPass += "<h1 class=\"m-y-0 \">" + this.apiData[i].ServiceName + "</h1>";
                            panelTextToPass += "<p class=\"lead\"><a href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\"  aria-label=\"" + this.apiData[i].FriendlyName + " Agency Details.\">" + this.apiData[i].FriendlyName + "</a></p>";
                            panelTextToPass += "<p>" + holderDescription + "</p><br>";
                            panelTextToPass += "<div class=\"btn-row m-b\">";
                            panelTextToPass += "<a href=\"" + this.apiData[i].ServiceUrl + "\" id=\"launch-" + serviceNameToPass + "\" class=\"btn btn-default btn-block-xs\" aria-label=\" Launch Service for " + this.apiData[i].ServiceName + " service. \"><span class=\"ca-gov-icon-computer\"></span> Launch Service</a>";
                            panelTextToPass += "<a href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\" class=\"btn btn-default btn-block-xs\" aria-label=\" See Details about the " + this.apiData[i].ServiceName + " service.\"><span class=\"ca-gov-icon-info\"></span> See Details</a>";
                            panelTextToPass += "                            </div>";
                            panelTextToPass += "<div class=\"location\" itemscope itemtype=\"http://schema.org/Organization\">";
...
//                    console.log(arrayLength);
    ...
    buildAgencyCard: function (agencyId, agencyLogo, agencyFriendlyName, agencyName, agencyAcronym, agencyUrl, agencyDescription, agencyContactPhone, agencyHearingImpairedPhone, agencyFaxNumber, PhoneHours, agencyContactUrl, agencyTwitterAccount, agencyFacebook, agencyYouTube, agencyContactEmail, agencyLiveChat, lang, agencyLandingPage) {
        ...
        cardToBuild += "<div class=\"row\">";
        cardToBuild += "<div class=\"col-lg-3\">";
        cardToBuild += "<img class=\"img-responsive hidden-xs\" src=\"" + imageUrlPrefix + "/";
        if (agencyLogo) {
        ...
        cardToBuild += "</div>";
        cardToBuild += "<div class=\"col-lg-9\">";
        cardToBuild += "<a aria-label=\"" + agencyFriendlyName + " Agency Details\" href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\" class=\"lead\" itemprop=\"name\">" + agencyFriendlyName + "</a>";
        cardToBuild += "<div class=\"row\">";
        cardToBuild += "<div class=\"col-lg-7\">";
        cardToBuild += "<p itemprop=\"description\">" + descriptionHolder + "</p>";
        ...
        cardToBuild += "</div>";
        cardToBuild += "<div class=\"col-lg-5\">";
        cardToBuild += "<a aria-label=\"Agency Profile details for " + agencyFriendlyName + "\" href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\" class=\"btn btn-secondary btn-block btn-sm m-t-md\">Agency Profile</a>";
        cardToBuild += "<div class=\"collapse collapse-" + agencyId + "-" + agencyAcronym.replace(' ', '') + "\">";
        cardToBuild += "<a aria-label=\"Contact Agency via contact page for " + agencyFriendlyName + "\" href=\"" + agencyContactUrl + "\" id=\"contact-" + agencyId + "-" + agencyAcronym.replace(' ', '') + "\" class=\"btn btn-secondary btn-block btn-sm\">Contact Agency</a>";
        if (agencyLiveChat) {
            cardToBuild += "<a aria-label=\"Live Chat Information for " + agencyFriendlyName + " \" href=\"" + agencyLiveChat + "\" id=\"livechat-" + agencyId + "-" + agencyAcronym.replace(' ', '') + "\" class=\"btn btn-secondary btn-block btn-sm\">Live Chat</a>";
        }
        ...
        if (agencyTwitterAccount) {
            ...
            cardToBuild += "<a aria-label=\"Twitter Information  for " + agencyFriendlyName + "\" href=\"https://twitter.com/" + thisitem1 + "\" id=\"twitter-" + agencyId + "-" + agencyAcronym.replace(' ', '') + "\"><span class=\"ca-gov-icon-twitter\" aria-hidden=\"true\"><span class=\"sr-only\">Twitter Information for " + agencyFriendlyName + "</span></span></a>";
            cardToBuild += "</li>";
        }
        if (agencyFacebook) {
            ...
            cardToBuild += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
            cardToBuild += "<a aria-label=\"Facebook Information for " + agencyFriendlyName + "\" href=\"https://www.facebook.com/" + thisitem2 + "\" id=\"facebook-" + agencyId + "-" + agencyAcronym.replace(' ', '') + "\"><span class=\"ca-gov-icon-facebook\" aria-hidden=\"true\"><span class=\"sr-only\">Facebook Information for " + agencyFriendlyName + "</span></span></a>";
            cardToBuild += "</li>";
        }
        if (agencyYouTube) {
            ...
            cardToBuild += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
            cardToBuild += "<a aria-label=\"YouTube Information for " + agencyFriendlyName + " \" href=\"https://www.youtube.com/" + thisitem3 + "\" id=\"youtube-" + agencyId + "-" + agencyAcronym.replace(' ', '') + "\"><span class=\"ca-gov-icon-youtube\" aria-hidden=\"true\"><span class=\"sr-only\">YouTube Information for " + agencyFriendlyName + "</span></span></a>";
            cardToBuild += "</li>";
        }
        if (agencyContactEmail) {
            cardToBuild += "<li style=\"margin-right:8px;margin-left: 8px;margin-top: 10px;\">";
            cardToBuild += "<a aria-label=\"Email To Link (which includes an email address) for " + agencyFriendlyName + "\" href=\"mailto:" + agencyContactEmail + "\"><span class=\"ca-gov-icon-share-email\" aria-hidden=\"true\"><span class=\"sr-only\">Email</span></span></a>";
            cardToBuild += "</li>";
        }
        cardToBuild += "</ul>";
        cardToBuild += "</div>";
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 50) {
                    ...
                    document.getElementById(idOfDivToFill).innerHTML = "<li>|||||</li>" + displayText;
                    ...
                    if (typeof serviceSearchResults[0] !== "undefined") {
                        ...
                        if (totalCount > 0) {
                            if (totalCount < 2) {
                                ...
                                if (currentPage > 0) {
                                    displayablePaginationBar += "<a aria-label=\" << Previous button to go to Previous Page of Service Search Results\"  style=\"text-decoration: none!important;\" href=\"javascript:switchToServicePage('" + (currentPage - 1) + "');\"><div class=\"td\"> << Previous</div></a>";
                                }

                                for (var p = 0; p < totalCount / pageSize; p++) {
                                    if (p === currentPage) {
                                        displayablePaginationBar += "<a aria-label=\"" + (p + 1) + " of " + Math.ceil(totalCount / pageSize) + " Pages of Services Search Results \" style=\"text-decoration: none!important;\" href=\"javascript:switchToServicePage('" + p + "');\"><div class=\"td\" style=\"color: #fff; background-color: #046B99; cursor: default;\">&nbsp;" + (p + 1) + "&nbsp;</div></a>";
                                    }
                                    else {
                                        displayablePaginationBar += "<a aria-label=\"" + (p + 1) + " of " + Math.ceil(totalCount / pageSize) + " Pages of Service Search Results. Click to go page " + (p + 1) + " of Service Search Results\" style=\"text-decoration: none!important;\" href=\"javascript:switchToServicePage('" + p + "');\"><div class=\"td\">&nbsp;" + (p + 1) + "&nbsp;</div></a>";
                                    }
                                }

                                if (upperNumber < totalCount) {
                                    displayablePaginationBar += "<a aria-label=\"Next >> to go to Next Page of Search Results\" style=\"text-decoration: none!important;\" href=\"javascript:switchToServicePage('" + (currentPage + 1) + "');\"><div class=\"td\">Next >> </div></a>";
                                }
                    ...
                    if (typeof agencySearchResults[0] !== "undefined") {
                        ...
                        if (totalCount > 0) {
                            if (totalCount < 2) {
                                ...
                                if (currentPage > 0) {
                                    displayablePaginationBar += "<a aria-label=\" << Previous Button to go to Previous Page of Agency Search Results\"  style=\"text-decoration: none!important;\" href=\"javascript:switchToAgencyPage('" + (currentPage - 1) + "');\"><div class=\"td\"> << Previous</div></a>";
                                }

                                for (var p = 0; p < totalCount / pageSize; p++) {
                                    if (p === currentPage) {
                                        displayablePaginationBar += "<a aria-label=\"" + (p + 1) + " of " + Math.ceil(totalCount / pageSize) + " Pages of Agency Search Results. You are currently on Agency Search Result Page " + (p + 1) + " \" style=\"text-decoration: none!important;\" href=\"javascript:switchToAgencyPage('" + p + "');\"><div class=\"td\" style=\"color: #fff; background-color: #046B99; cursor: default;\">&nbsp;" + (p + 1) + "&nbsp;</div></a>";
                                    }
                                    else {
                                        displayablePaginationBar += "<a aria-label=\"" + (p + 1) + " of " + Math.ceil(totalCount / pageSize) + " Pages. Click to go to page " + (p + 1) + " of Agency Search Results\" style=\"text-decoration: none!important;\" href=\"javascript:switchToAgencyPage('" + p + "');\"><div class=\"td\">&nbsp;" + (p + 1) + "&nbsp;</div></a>";
                                    }
                                }

                                if (upperNumber < totalCount) {
                                    displayablePaginationBar += "<a aria-label=\"Next >> button to go to Next Page of Agency Search Results\" style=\"text-decoration: none!important;\" href=\"javascript:switchToAgencyPage('" + (currentPage + 1) + "');\"><div class=\"td\">Next >> </div></a>";
                                }
        ...
        function loadResults() {
            ...
            if (loadFlag === false) {
                ...
                if (loadCount < 50) {
                    ...
                    for (var i = 0; i < arrayLength; i++) {
                        var agencyNameToPass = processJsonData.processPassedItem('Out', result[i].FriendlyName);
                        displayText += "<li><a aria-label=\"" + result[i].FriendlyName + " agency details\" href=\"" + agencyLandingPage + "?item=" + agencyNameToPass + "\">" + result[i].FriendlyName + "</a><span style=\"padding: 0px, margin: 0px;\" id=\"serviceHolder" + result[i].AgencyId + "\"></span></li>";
            ...
            if (this.readyState === 4 && this.status === 200) {
                if (this.responseText.length > 10) {
                    ...
                    for (var i = 0; i < arrayLength; i++) {
                        ...
                        displayText += "<li><a aria-label=\"" + dataToProcess[i].ServiceName + " Service Details ( This is a service provided by " + dataToProcess[i].FriendlyName + " ) \" href=\"" + serviceLandingPage + "?item=" + serviceNameToPass + "\">" + dataToProcess[i].ServiceName + "</a></li>";
                    }
                    displayText += "</ul>";
