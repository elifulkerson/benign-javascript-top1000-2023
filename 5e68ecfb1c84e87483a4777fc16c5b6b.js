    ...
    return {
        ...
        registerDelegatedEvent: function (selector, event, params, asyncPayload,
            ...
            try {
                ...
                var delegateListener = CookiesManager.waitForUserDecision(function(e) {
                    if (useNinjaBeta && !CookiesManager.isConsentGivenForCookie('onap')) {
                        return;
                    }
            ...
            [].forEach.call(nodes, function(node) {
                try {
                    var eventType = event,
                        ...
                        listener = CookiesManager.waitForUserDecision(function(e) {
                            if (useNinjaBeta && !CookiesManager.isConsentGivenForCookie('onap')) {
                                return;
                            }
